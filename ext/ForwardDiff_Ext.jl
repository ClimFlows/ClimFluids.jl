...
import ClimFluids.ForwardDiff: exner_functions
...
@inline function exner_functions(gas::SimpleFluid, (p_, consvar_)::PCons)
...
@inline function exner_functions(gas::BinaryFluid, (p_, consvar_, q_)::PConsQ)
